...
def detect(opt):
    ...
    source, weights, view_img, save_txt, imgsz, trace, save_txt_tidl, kpt_label = opt.source, opt.weights, opt.view_img, opt.save_txt, opt.img_size, not opt.no_trace, opt.save_txt_tidl, opt.kpt_label
    ...
    for path, img, im0s, vid_cap in dataset:
        ...
        for i, det in enumerate(pred):  # detections per image
            ...
            s += '%gx%g ' % img.shape[2:] # add from yolov7 pose
